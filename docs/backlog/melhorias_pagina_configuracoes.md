...
- Nota: existe também `docs/backlog/permissoes_pelo_pagina_confg.md`, que propõe (para o futuro, escopo maior) um RBAC granular por checkbox por usuário na tela de Efetivo — é um projeto maior e complementar a este achado, não o mesmo escopo.
